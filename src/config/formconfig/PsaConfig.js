...
type Props = {
  manualCourtCasesAndCharges :boolean
}
const psaConfig = ({ manualCourtCasesAndCharges } :Props) => {

  const caseName = manualCourtCasesAndCharges
    ? APP_TYPES_FQNS.MANUAL_PRETRIAL_COURT_CASES
    : APP_TYPES_FQNS.MANUAL_PRETRIAL_CASES;

  const chargeName = manualCourtCasesAndCharges
    ? APP_TYPES_FQNS.MANUAL_COURT_CHARGES
    : APP_TYPES_FQNS.MANUAL_CHARGES;
    ...
    entitySets: [
      ...
      },
      {
        ...
        fields: {
          ...
          [PROPERTY_TYPES.ARRESTING_AGENCY]: PROPERTY_TYPES.ARRESTING_AGENCY
        }
      },
      {
        name: chargeName,
