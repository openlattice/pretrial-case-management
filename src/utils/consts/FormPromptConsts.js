...
export const CURRENT_AGE_PROMPT =
  'What was the defendant’s age at the time of the arrest or administering the PSA – Court?';
export const CURRENT_VIOLENT_OFFENSE_PROMPT = 'Is any current charge considered violent?';
export const PENDING_CHARGE_PROMPT =
  'Did the defendant have at least one other pending charge at the time of the alleged offense?';
...
export const PRIOR_FAILURE_TO_APPEAR_RECENT_PROMPT =
  'How many prior pretrial failures to appear does the defendant have in the past 2 years?';
export const PRIOR_FAILURE_TO_APPEAR_OLD_PROMPT =
  'Does the defendant have any prior pretrial failures to appear that are older than 2 years?';
export const PRIOR_SENTENCE_TO_INCARCERATION_PROMPT = 'Does the defendant have any prior sentence to incarceration?';
