...
export const HEADERS = {
  ...
  PSA_TYPE: `${PROPERTY_TYPES.CONTEXT}|${APP_TYPES.RCM_RISK_FACTORS}`,
  ...
  EXTRADITED: `${PROPERTY_TYPES.EXTRADITED}|${APP_TYPES.RCM_RISK_FACTORS}`,
  EXTRADITED_NOTES: `${PROPERTY_TYPES.EXTRADITED_NOTES}|${APP_TYPES.RCM_RISK_FACTORS}`,
  RCM_STEP_2_CHARGES: `${PROPERTY_TYPES.RCM_STEP_2_CHARGES}|${APP_TYPES.RCM_RISK_FACTORS}`,
  RCM_STEP_2_CHARGES_NOTES: `${PROPERTY_TYPES.RCM_STEP_2_CHARGES_NOTES}|${APP_TYPES.RCM_RISK_FACTORS}`,
  RCM_STEP_4_CHARGES: `${PROPERTY_TYPES.RCM_STEP_4_CHARGES}|${APP_TYPES.RCM_RISK_FACTORS}`,
  RCM_STEP_4_CHARGES_NOTES: `${PROPERTY_TYPES.RCM_STEP_4_CHARGES_NOTES}|${APP_TYPES.RCM_RISK_FACTORS}`,
  RCM_SECONDARY_RELEASE_CHARGES: `${PROPERTY_TYPES.RCM_SECONDARY_RELEASE_CHARGES}|${APP_TYPES.RCM_RISK_FACTORS}`,
  RCM_SECONDARY_RELEASE_CHARGES_NOTES: `${PROPERTY_TYPES.RCM_SECONDARY_RELEASE_CHARGES_NOTES}|${APP_TYPES.RCM_RISK_FACTORS}`,
  RCM_SECONDARY_HOLD_CHARGES: `${PROPERTY_TYPES.RCM_SECONDARY_HOLD_CHARGES}|${APP_TYPES.RCM_RISK_FACTORS}`,
  RCM_SECONDARY_HOLD_CHARGES_NOTES: `${PROPERTY_TYPES.RCM_SECONDARY_HOLD_CHARGES_NOTES}|${APP_TYPES.RCM_RISK_FACTORS}`,
  COLOR: `${PROPERTY_TYPES.COLOR}|${APP_TYPES.RCM_RESULTS}`,
  RELEASE_TYPE: `${PROPERTY_TYPES.RELEASE_TYPE}|${APP_TYPES.RCM_RESULTS}`,
  CONDITIONS_LEVEL: `${PROPERTY_TYPES.CONDITIONS_LEVEL}|${APP_TYPES.RCM_RESULTS}`,
  BOOKING_CONDITIONS: `${PROPERTY_TYPES.TYPE}|${APP_TYPES.RCM_BOOKING_CONDITIONS}`,
  COURT_CONDITIONS: `${PROPERTY_TYPES.TYPE}|${APP_TYPES.RCM_COURT_CONDITIONS}`,
  CONDITION_1: `${PROPERTY_TYPES.CONDITION_1}|${APP_TYPES.RCM_RESULTS}`,
  CONDITION_2: `${PROPERTY_TYPES.CONDITION_2}|${APP_TYPES.RCM_RESULTS}`,
  CONDITION_3: `${PROPERTY_TYPES.CONDITION_3}|${APP_TYPES.RCM_RESULTS}`,
  LEGACY_JUDGE_OUTCOME: `${PROPERTY_TYPES.OUTCOME}|${APP_TYPES.RCM_RESULTS}`,
...
export const HEADERS_OBJ = {
  ...
  [HEADERS.RCM_STEP_2_CHARGES]: 'STEP 2 CHARGES',
  [HEADERS.RCM_STEP_2_CHARGES_NOTES]: 'STEP 2 NOTES',
  [HEADERS.RCM_STEP_4_CHARGES]: 'STEP 4 CHARGES',
  [HEADERS.RCM_STEP_4_CHARGES_NOTES]: 'STEP 4 NOTES',
  [HEADERS.RCM_SECONDARY_RELEASE_CHARGES]: 'BHE',
  [HEADERS.RCM_SECONDARY_RELEASE_CHARGES_NOTES]: 'BHE NOTES',
  [HEADERS.RCM_SECONDARY_HOLD_CHARGES]: 'BRE',
  [HEADERS.RCM_SECONDARY_HOLD_CHARGES_NOTES]: 'BRE NOTES',
  [HEADERS.COLOR]: 'PSA COLOR',
  [HEADERS.RELEASE_TYPE]: 'RELEASE TYPE',
  [HEADERS.CONDITIONS_LEVEL]: 'COND LVL',
  [HEADERS.BOOKING_CONDITIONS]: 'BOOKING RELEASE CONDITIONS',
  [HEADERS.COURT_CONDITIONS]: 'COURT RELEASE CONDITIONS',
  [HEADERS.CONDITION_1]: 'LEGACY REL COND 1',
  [HEADERS.CONDITION_2]: 'LEGACY REL COND 2',
  [HEADERS.CONDITION_3]: 'LEGACY REL COND 3',
